...
public class PiggyBankScreen extends HandledScreen<PiggyBankContainer> {

    private static final Identifier TEXTURE = new Identifier("textures/gui/container/hopper.png");

    public PiggyBankScreen(PiggyBankContainer handler, PlayerInventory inventory, Text title) {
