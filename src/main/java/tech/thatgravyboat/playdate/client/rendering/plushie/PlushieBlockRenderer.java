...
public class PlushieBlockRenderer<T extends PlushieBlockEntity> extends GeoBlockRenderer<T> {
    ...
    public static PlushieBlockRenderer<PlushieBlockEntity> create(BlockEntityRendererFactory.Context context) {
        return new PlushieBlockRenderer<>(new PlushieBlockModel());
    }

    public static PlushieBlockRenderer<CuddleCubBlockEntity> createCuddleCub(BlockEntityRendererFactory.Context context) {
        return new PlushieBlockRenderer<>(new CuddleCubBlockModel());
    }
}
